...
CLONE_DB_URI = environ.get("CLONE_DB_URI", "mongodb+srv://kd142047:GY6nVvEqgugGogTl@token.b9jb0.mongodb.net/?retryWrites=true&w=majority&appName=token")
CDB_NAME = environ.get("CDB_NAME", "token")
